...
In a typical environment, this script can complete a fast musrfit installation within about five minutes, depending mainly on your internet speed.
...
3. After the success message, open a new shell or manually source `.bashrc`, then start musrfit.
...
- Run the script as a normal user, not as `root`, to avoid later permission problems when editing files in your musrfit working environment
